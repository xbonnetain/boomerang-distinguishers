/*
 * Rotational-xor-differential boomerang test on Simon
 *
 * Authors:
...
//#define SAMPLE
    ...
    u32 delta_in = 0x40a113;
    u32 delta_out = 0x82002;
    ...
    for(int k=0; k<nbkeys; k++) {
        ...
        for(u64 m=0; m<nbmsg; m++) {
            ...
            u32 cipher3 = cipher1 ^ delta_out;
            u32 cipher4 = cipher2 ^ protl(delta_out,16);
            u32 plain3 = Simon32Decrypt(cipher3, key1, nb_rounds);
            u32 plain4 = Simon32Decrypt(cipher4, key2, nb_rounds);
